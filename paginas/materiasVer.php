                        ...
                        <div class="rightD_inner">
                            <div class="campos_info">
                                ...
                                <div class="datos_li">
                                    ...
                                    <span class="txt_vermate"><?php echo $nombre_materia ?></span>
                                </div>
                                ...
                                <div class="datos_li">
                                    <div class="icon">
                                        ...
                                        <?php foreach ($instructor as $objInstructor) {
                                            if ($id_instructor != $objInstructor->getId_instructor()) ?>
                                           <a href="usuarios_ver.php?cedu=<?php echo $objInstructor->getCedula()?>" class="txt_vermate"> <?php if ($id_instructor == $objInstructor->getId_instructor()) echo $objInstructor->getNombre_completo(); ?></a>
                                        <?php } ?>
