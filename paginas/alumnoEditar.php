                        ...
                        <div class="datos_contacto pb">
                            ...
                            <div class="contacto">
                                <ul>
                                    ...
                                    <li>
                                        <div class="datos_li">
                                            <input type="number" class="input_contact" placeholder="Identificacion" id="identificacion" name="identificacion" value="<?php echo $identificacion ?>">
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        <div class="datos_li">
                                            <input type="text" class="input_contact" placeholder="Segundo Nombre" id="nombre_2" name="nombre_2" value="<?php echo $nombre_2 ?>">
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        <div class="datos_li">
                                            <input type="text" class="input_contact" placeholder="Segundo Apellido" id="apellido_2" name="apellido_2" value="<?php echo $apellido_2 ?>">
                                        </div>
                                    </li>
