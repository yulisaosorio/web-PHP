...
?>
    ...
    <body>
        ...
        $query = "SELECT PER.id_persona,PER.cedula,CONCAT(PER.nombre_1,' ',PER.nombre_2,' ',PER.apellido_1) as nombre,PER.clave,PER.telefono,PER.direccion,PER.fecha_nac,ROL.nombre_rol AS rol, EST.nombre AS estado,PER.foto
          ...
          ORDER BY PER.nombre_1 LIMIT $empieza,$por_pagina";
        ...
        <div class="datatable-container">
                    ...
                    <?php while ($fila = mysqli_fetch_assoc($resultado)) { ?>
                        <tr>
                            ...
                            <td class="administrar">
                                ...
                                <a class="modificarImg" href="paginas/imgEditar.php?cedu=<?php echo $fila['cedula'] ?>">
                                    <span class="icon_ver">modificar img<i class=""></i></span>
                                </a>
                            </td>
                        </tr>
                    <?php } ?>
            ...
            <div class="footer-tools">
                ...
                ORDER BY PER.nombre_1";
                    ...
                    <ul>
                        <li><a class="activePrimera" href="#" onclick="ajax('contenido', 'paginas/tablaUsuarios.php?pagina=1')">Primera</a></li>
                        <?php for ($i = 1; $i <= $total_paginas; $i++) { ?>
                            <li><a class="active2" href="#" onclick="ajax('contenido', 'paginas/tablaUsuarios.php?pagina=<?php echo $i ?>')"><?php echo $i ?></a></li>
                        <?php } ?>
                        <li><a class="activeUltima" href="#" onclick="ajax('contenido','paginas/tablaUsuarios.php?pagina=<?php echo $total_paginas ?>')">Ultima</a></li>
                    </ul>
                </div>
            </div>
