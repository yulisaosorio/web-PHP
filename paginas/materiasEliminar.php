    ...
    <div class="wrapper">
        ...
        <div class="wrapper_inner" id="wrapper_inner">
            ...
            <form class="container" action="" method="POST" enctype="multipart/form-data">
                <div class="resume" style="height: 50%;">
                        ...
                        <div class="rightD_inner">
                            ...
                            <div class="boton">
                                ...
                                <?php if ($consultado == true) { ?>
                                    ...
                                    <button type="submit" name="accion" value="Eliminar" class="bton  btn bton_guardar">Eliminar</button>
                                <?php } ?>
                                ...
                                <a href="../paginaPrincipal.php" class="bton bton_cancelar" >cancelar</a>
