...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="wrapper_inner" id="wrapper_inner">
            ...
            <form class="container" id="formulario" action="" method="POST" enctype="multipart/form-data">
                <div class="resume">
                    <div class="left">

                        <div class="img_holder">
                            <?php if ($consultado == true) { ?>
                                <img class="img-thumbnail" src="../fotos/<?php echo $nombreArchivo ?> " width="150px" />
                                <input type="file" src="" accept="image/*" id="foto" name="foto" class="fotoUsuario">
                            <?php } else { ?>
                                <img src="../img/perfil.jpg" id="img" alt="foto">
                                <input type="file" src="" accept="image/*" id="foto" name="foto" class="fotoUsuario">
                            <?php } ?>
                        </div>
                        ...
                        <div class="contact_wrap pb">
                            ...
                            <div class="contact">
                                <ul>
                                    ...
                                    <li>
                                        <div class="li_wrap">
                                            <input autocomplete="off" type="text" class="contact_input" id="nombre_2" name="nombre_2" value="<?php echo $nombre_2 ?>" placeholder="Segundo Nombre">
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        <div class="li_wrap">
                                            <input autocomplete="off" type="text" class="contact_input" id="apellido_2" name="apellido_2" value="<?php echo $apellido_2 ?>" placeholder="Segundo Apellido">
                                        </div>
                                    </li>

                                    <li>
                                        <div class="li_wrap">
                                            <input type="date" class="contact_input" id="fecha_nac" name="fecha_nac" value="<?php echo $fecha_nac ?>" placeholder="fecha de nacimiento">
                                        </div>
                                    </li>
                        ...
                        <div class="right_inner">
                            ...
                            <div class="campos_contactos">
                                ...
                                <div class="li_wrap">
                                    ...
                                    <input type="email" class="contact_input correo right" id="correo" name="correo" value="<?php echo $correo ?>" placeholder="Correo">
                                </div>
                            </div>
                                ...
                                <div class="li_wrap">
                                    <select class="selecionar " name="estados" id="estados">
                                        ...
                                        foreach ($estado as $objEstado) {
                                            // if ($objEstado->getId_estado() == $id_estado)
                                        ?>
                                            <option value="<?php echo $objEstado->getId_estado(); ?>"><?php echo $objEstado->getNombre(); ?> </option>
                                        <?php } ?>
                                    </select>
                                </div>
                                ...
                                <div class="li_wrap">
                                    <select class="selecionar " name="rols" id="rols">
                                        ...
                                        foreach ($rolUser as $objRol) {
                                            // if ($objRol->getId_rol() != $id_rol)
                                        ?>
                                            <option value="<?php echo $objRol->getId_rol(); ?>"><?php echo $objRol->getNombre_rol(); ?> </option>
                                        <?php } ?>
                                    </select>
