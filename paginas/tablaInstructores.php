        ...
        <div class="footer-tools">
            ...
            <div class="pages">
              ...
              WHERE ROL.id_rol = 2 ORDER BY PER.nombre_1";
                ...
                <ul>
                    <li><a class="activePrimera" href="#" onclick="ajax('contenido', 'paginas/tablaInstructores.php?pagina=1')">Primera</a></li>
                    <?php for ($i = 1; $i <= $total_paginas; $i++) { ?>
                        <li><a class="active2" href="#" onclick="ajax('contenido', 'paginas/tablaInstructores.php?pagina=<?php echo $i ?>')"><?php echo $i ?></a></li>
                    <?php } ?>
                    <li><a class="activeUltima" href="#" onclick="ajax('contenido','paginas/tablaInstructores.php?pagina=<?php echo $total_paginas ?>')">Ultima</a></li>
                </ul>
            </div>
        </div>
